...
public class Testaaja {
    ...
    public Testaaja(Kuvanlukija kuvanlukija, int ensimmainenHlo, int ensimmainenKuva, int henkiloMaara) {
    ...
    public void testaaOnnistumisprosentit() {
    ...
    public String lueOnnistumisprosentit() {
        StringBuilder sb = new StringBuilder();
        sb.append("4 opetuskuvaa, 6 testikuvaa / henkilö:\nonnistumisprosentti: " + onnistumisprosentit[0] + "\n");
        sb.append("2 x 4 opetuskuvaa, 2 testikuvaa / henkilö:\nonnistumisprosentti: " + onnistumisprosentit[1] + "\n");
        sb.append("3 x 3 opetuskuvaa, 1 testikuva / henkilö:\nonnistumisprosentti: " + onnistumisprosentit[2] + "\n");
        return sb.toString();
    }
